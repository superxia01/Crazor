...
### P1：客户 Case 已补深链路、项目任务联动、文档搜索和附件归档

**现象**

- 客户基础资料、跟进记录、需求文档、文档打开编辑、客户文档正文搜索、附件上传/下载/删除、成交登记、渠道转介绍、项目机会、项目任务拆解已经可以在客户详情完成第一层深链路。
...
客户维护到项目任务、需求文档和附件归档的核心链路已经可以演示，客户详情不再需要跳出统一入口处理文档检索和附件归档。

**建议**

下一步补附件类型/大小策略、附件预览、关键客户动作提醒和更细的客户级权限边界。
...
2. 补附件类型/大小策略、客户附件预览、关键客户动作提醒和客户级权限边界。
