...
### P1：客户 Case 已补深链路、项目任务联动、提醒处理、文档搜索、附件策略和附件预览
...
客户维护到项目任务、跟进提醒、需求文档和附件归档的核心链路已经可以演示，客户详情不再需要跳出统一入口处理提醒、文档检索、附件归档和常见附件预览。

**建议**

下一步补客户级权限边界、跨模块提醒规则、附件病毒扫描/敏感信息扫描和更多格式预览。
...
2. 补客户级权限边界、跨模块提醒规则、附件病毒扫描/敏感信息扫描和更多格式预览。
