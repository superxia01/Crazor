...
export const CRAZOR_INTERNAL_ACCESS_CODE = process.env.CRAZOR_INTERNAL_ACCESS_CODE || ''
...
export const CRAZOR_DELIVERY_CONTACT_ID = process.env.CRAZOR_DELIVERY_CONTACT_ID || ''
