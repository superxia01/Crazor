...
const TOOLS: any[] = [
  ...
  {
    name: "create_doc",
    description: "创建知识库/AI笔记文档。文件夹ID为路径格式，如 'knowledge/20-业务流程/30-客户管理'。常见路径：00-关于我、10-百科、20-业务流程/10-公域流量、20-业务流程/20-私域运营、20-业务流程/30-客户管理、20-业务流程/45-项目管理、30-素材资产。若不确定路径，先用 list_docs 查看目录树。",
    inputSchema: {
      type: "object",
      properties: {
        ...
        folder_id: { type: "string", description: "所属文件夹路径ID，如 'knowledge/20-业务流程/30-客户管理'。空则放根目录" },
        contact_id: { type: "string", description: "关联客户ID" },
      },
  ...
  {
    name: "list_docs",
    description: "列出文件夹下的文档。返回完整目录树（folders + notes）。文件夹ID为路径格式，如 'knowledge/20-业务流程'。不传 folder_id 返回完整树。",
    inputSchema: {
      type: "object",
      properties: {
  ...
  {
    name: "create_folder",
    description: "创建文件夹。parent_id 为路径格式，如 'knowledge/20-业务流程'。",
    inputSchema: {
      type: "object",
      properties: {
        scope: { type: "string", enum: ["knowledge", "notebook"] },
        name: { type: "string", description: "文件夹名称" },
        parent_id: { type: "string", description: "父文件夹路径ID，如 'knowledge/20-业务流程'" },
      },
      required: ["scope", "name"],
    },
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        path: { type: "string", description: "相对于知识库根目录的路径，如 '00-关于我/10-定位与品牌/IP定位.md'" },
      },
      required: ["path"],
    },
  },
