...
const ENTITY_GROUPS: Record<string, string[]> = {
  ...
  project: ["project", "task", "delivery", "project_attachment", "delivery_attachment"],
  projects: ["project", "task", "delivery", "project_attachment", "delivery_attachment"],
  delivery: ["delivery", "delivery_attachment"],
  deliveries: ["delivery", "delivery_attachment"],
