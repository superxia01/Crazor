...
| 文件路径 | 用途 |
|----------|------|
| `关于我/定位与品牌/IP定位.md` | 了解定位，确保内容调性一致 |
| `关于我/定位与品牌/品牌风格指南.md` | 语气基调、口头禅、排版偏好 |
| `关于我/目标客户/目标客户画像.md` | 了解读者是谁 |
| `关于我/目标与节奏/日常工作节奏.md` | 公众号发布频率和时间 |

## 知识库目录结构

| 目录路径 | 用途 |
|----------|------|
| `业务流程/公域流量/内容管理/公众号/` | 公众号文章草稿和已发布存档 |
