...
| 文件路径 | 用途 |
|----------|------|
| `关于我/定位与品牌/IP定位.md` | 了解用户的核心定位和内容方向 |
| `关于我/定位与品牌/品牌风格指南.md` | 语气基调、内容调性要求 |
| `关于我/目标客户/目标客户画像.md` | 内容写给谁看，决定选题方向 |
| `关于我/目标与节奏/日常工作节奏.md` | 发布频率和时间安排 |

## 知识库目录结构

| 目录路径 | 用途 |
|----------|------|
| `业务流程/公域流量/选题池/` | 存放所有选题卡 |
| `业务流程/公域流量/排期表/` | 周排期和月排期 |
