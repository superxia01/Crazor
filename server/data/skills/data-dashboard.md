...
所有报告文档存储在 `20-业务流程/70-数据看板/` 文件夹下：

| 报告类型 | 存储路径 | 文档标题格式 |
|----------|----------|-------------|
| 周报 | `20-业务流程/70-数据看板/` | `W{{XX}}周报-{{MM.DD}}-{{MM.DD}}` |
| 月报 | `20-业务流程/70-数据看板/` | `{{YYYY}}年{{MM}}月月报` |
| 季度复盘 | `20-业务流程/70-数据看板/` | `{{YYYY}}年Q{{N}}季度复盘` |
| KPI追踪 | `20-业务流程/70-数据看板/` | `年度KPI追踪` / `月度KPI追踪` |
| 看板索引 | `20-业务流程/70-数据看板/` | `看板索引` |
