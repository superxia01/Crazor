...
test("customer delivery records are a real business module across API, UI, context, and smoke checks", () => {
  ...
  assert.ok(
    ...
    "server should route delivery CRUD, analytics, read protection, and readiness checks",
  )
  ...
  assert.ok(
    ...
    "frontend should expose an editable delivery management workspace",
  )
  ...
  assert.ok(
    ...
    "customer delivery and Docker smoke tests should verify the delivery chain",
  )
})
